    ...
    <div class="divBanner banner-swiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="images/slide-casino1-cn.jpg">
        </div>
        <div class="swiper-slide">
          <img src="images/slide-casino2-cn.jpg">
        </div>
      </div>
    </div>
    <div class="w1440">
      <div style="padding:20px 0 30px;">
        <div class="casinogames-container">
            ...
            <div class="cg-list">
              <div class="gameslist casino-list">
                <ul>
                  <li>
                    <div class="gl-box cg-box baccarat">
                      <div class="gl-img">
                        ...
                        <div class="gl-hover">
                          <button class="btn-playnow" value="ab"> PLAY NOW </button>
                        </div>
                      </div>
                      <h3>ALLBET</h3>
                    </div>
                  ...
                  <li>
                    <div class="gl-box cg-box sicbo">
                      <div class="gl-img">
                        ...
                        <div class="gl-hover">
                          <button class="btn-playnow" value="ag"> PLAY NOW </button>
                        </div>
                      </div>
                      <h3>ASIA GAMING</h3>
                    </div>
                  ...
                  <li>
                    <div class="gl-box cg-box roulette">
                      <div class="gl-img">
                        <img src="images/nav-bggaming.png">
                        <div class="gl-hover">
                          <button class="btn-playnow" value="bg"> PLAY NOW </button>
                        </div>
                      </div>
                      <h3>BG CASINO</h3>
                    </div>
                  ...
                  <li>
                    <div class="gl-box cg-box sicbo">
                      <div class="gl-img">
                        ...
                        <div class="gl-hover">
                          <button class="btn-playnow" value="ezugi"> PLAY NOW </button>
                        </div>
                      </div>
                      <h3>EZUGI</h3>
                    </div>
                  ...
                  <li>
                    <div class="gl-box cg-box roulette">
                      <div class="gl-img">
                        ...
                        <div class="gl-hover">
                          <button class="btn-playnow" value="fgg"> PLAY NOW </button>
                        </div>
                      </div>
                      <h3>FGG CASINO</h3>
                    </div>
                  ...
                  <li>
                    <div class="gl-box cg-box baccarat">
                      <div class="gl-img">
                        ...
                        <div class="gl-hover">
                          <button class="btn-playnow" value="ct855"> PLAY NOW </button>
                        </div>
                      </div>
                      <h3>CT855</h3>
                    </div>
                  ...
                  <li>
                    <div class="gl-box cg-box sicbo">
                      <div class="gl-img">
                        ...
                        <div class="gl-hover">
                          <button class="btn-playnow" value="ls"> PLAY NOW </button>
                        </div>
                      </div>
                      <h3>LUCKY STREAK</h3>
                    </div>
                  ...
                  <li>
                    <div class="gl-box cg-box baccarat">
                      <div class="gl-img">
                        ...
                        <div class="gl-hover">
                          <button class="btn-playnow" value="sb"> PLAY NOW </button>
                        </div>
                      </div>
                      <h3>SEXY BACCARAT</h3>
                    </div>
                  ...
                  <li>
                    <div class="gl-box cg-box sicbo">
                      <div class="gl-img">
                        ...
                        <div class="gl-hover">
                          <button class="btn-playnow" value="wm"> PLAY NOW </button>
                        </div>
                      </div>
                      <h3>WM CASINO</h3>
                    </div>
      ...
      <script type="text/javascript">
        $(function() {
          $('.btn-filter').on('click', function() {
            ...
            var thiscg = $(this).attr('data-cg');
            if (thiscg == "all") {
              $('.cg-box').parent('li').show();
            } else {
              $('.cg-box').parent('li').hide();
              $('.cg-box.' + thiscg).parent('li').show();
            }
          });
          var casinologos = new Swiper('.casino-logos', {
            slidesPerView: 6,
            navigation: {
              nextEl: ".casl-next",
              prevEl: ".casl-prev",
