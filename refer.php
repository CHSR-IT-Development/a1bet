...
<div class="tabs">
  ...
  <div class="tabs-stage">
    <div id="tab-1">
	  ...
	  <h3>MY QR CODE</h3>
	  <img src="https://chart.googleapis.com/chart?chs=500x500&cht=qr&choe=UTF-8&chl=YZCWZD" width="100%" height="auto">
	  ...
	  <p>Refferal ID: <b>YZCWZD</b></p>
	  <p><input type="text" value="https://a1bet.store/UAT/register.php?id=YZCWZD" id="myInput" disabled>
		<button onclick="myFunction()" class="bbz">COPY</button></p>
		
		
	  <p class="sharer">Share Link: <a href="https://wa.me/?text=Im%20inviting%20you%20to%20join%20this%20game.%20Register%20now%3A%20https%3A%2F%2Fa1bet.store%2FUAT%2Fregister.php%3Fid%3DYZCWZD" style="background-color:transparent;"><img src="images/wa.png"></a> <img src="images/wechat.png"></p>
  ...
  <tr>
    ...
    <div id="tab-2">
	  ...
	  <p><input type="text" class="inprt" value="" placeholder="Search...">
		<button class="bbz">SEARCH</button></p>
